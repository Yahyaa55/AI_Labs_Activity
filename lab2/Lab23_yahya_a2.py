...
symbol = "AAPL"  # Change this to the desired stock symbol                # a1 ++++
start_date = "2018-10-01"                                                 # a1 ++++
end_date = "2018-10-24"                                                   # a1 ++++
dataset_test = yf.download(symbol, start=start_date, end=end_date)        # a1 ++++
...
# Web model deployment with streamlit
st.header("Stock Price Prediction")
st.image("images/robot.jpg")
symbol = st.sidebar.selectbox("Stock symbol",["AAPL","GOOGL","MSFT"])
st.write(symbol)
